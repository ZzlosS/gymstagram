...
<?php
	...
	$ok = false;
	$gname = $name = $gender = $lname = $email = $pass = $error = $error2 = $alert = $redirect = '';
	$bday = $date;
	if(isset($_POST['email'])){
        ...
        $s2 = sS($_POST['s2']);
		$q2 = sS($_POST['q2']);
        $st = sS($_POST['st']); //da se obrise svuda
		if($gname == '' || $name == '' || $lname == '' || $email == '' || $pass == '' || $q1 == '' || $q2 == '' || $st == ''){
			$alert = $lang['NotAll'];
		...
		elseif($s1 == 'cq1' || $s2 == 'cq2'){
            ...
            elseif($result->num_rows){
                ...
                qM("INSERT INTO `members`(`gym_name`, `name`, `lname`, `gender`, `birth_date`, `email`, `pass`, `q1_id`, `question1`, `q2_id`, `question2`, `security_text`)
                    VALUES ('$gname', '$name', '$lname', $gender, '$bday', '$email', '$hpass', '$s1', '$q1', '$s2', '$q2', '$st')");
        ...
        <section id="content2">
            <form method="post" action="signup.php">
                ...
                <div class="radio">
                    ...
                    <ul id="s_ul">
                        <li id="s_li">
                            <input type="radio" id="f-option" name="selector" checked value="1"/>
                ...
                <p><label>Birthday: <br><input class='d_in' name="datepicker" type="text" id="datepicker" /></label></p>
                <br>
